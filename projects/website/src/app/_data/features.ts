...
export const FEATURES: MarketingFeature[] = [
  {
    slug: 'profile',
    name: $localize`:@@feat.storefront.name:Profile`,
    icon: '👤',
    tone: 'amber',
    oneLiner: $localize`:@@feat.storefront.one:Your public, bookable coaching page`,
    preview: '/videos/feature-storefront.en.mp4',
    poster: '/videos/feature-storefront.en.jpg',
    h1Lead: $localize`:@@feat.storefront.h1a:A coaching page people`,
    h1Accent: $localize`:@@feat.storefront.h1b:book on sight.`,
    intro: $localize`:@@feat.storefront.intro:Your profile is the page you send people to. It shows who you are, what you run, and lets someone book without a single back and forth message.`,
    capabilities: [
    ...
    faq: [
      {
        ...
        a: $localize`:@@feat.storefront.a1:No. Your profile is the page. If you already have a site, link to it from there.`,
      },
      {
      ...
      {
        q: $localize`:@@feat.storefront.q3:Is my profile public?`,
    ...
    metaTitle: $localize`:@@feat.storefront.mt:Coach profile: a free bookable page | MotionHive`,
  ...
  },
  {
    ...
    related: ['profile', 'programs', 'payments'],
  ...
  },
  {
    ...
    h1Accent: $localize`:@@feat.programs.h1b:stick to.`,
  ...
  },
  {
    ...
    preview: '/videos/feature-exercises.en.mp4',
    poster: '/videos/feature-exercises.en.jpg',
    ...
    related: ['programs', 'messaging', 'profile'],
  ...
  },
  {
    ...
    related: ['profile', 'sessions', 'programs'],
  ...
  },
  {
    ...
    icon: '💬',
    tone: 'teal',
    oneLiner: $localize`:@@feat.messaging.one:Message clients 1:1, where the training lives`,
    preview: '/videos/feature-messaging.en.mp4',
    poster: '/videos/feature-messaging.en.jpg',
    h1Lead: $localize`:@@feat.messaging.h1a:A message at the right`,
    h1Accent: $localize`:@@feat.messaging.h1b:moment.`,
  ...
  },
  {
    ...
    related: ['messaging', 'sessions', 'profile'],
