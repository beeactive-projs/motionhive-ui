  ...
  protected readonly placeholders = computed(() => {
    ...
    switch (type) {
      case FeedbackCategories.Bug:
        return {
          title: $localize`:@@feedback.placeholder.bug.title:e.g. Session attendance not saving correctly`,
          message: $localize`:@@feedback.placeholder.bug.message:What were you doing when it happened? What did you expect vs. what actually occurred?`,
        };
      case FeedbackCategories.Suggestion:
        return {
          title: $localize`:@@feedback.placeholder.suggestion.title:e.g. Show progress charts per client`,
          message: $localize`:@@feedback.placeholder.suggestion.message:Describe the feature and how it would improve your workflow as a trainer or organizer...`,
        };
      default:
        return {
          title: $localize`:@@feedback.placeholder.other.title:e.g. Question about managing group sessions`,
          message: $localize`:@@feedback.placeholder.other.message:What's on your mind? We're happy to help.`,
        };
    }
  });
    ...
    this._feedbackService
      ...
      .subscribe({
        ...
        error: () => {
          ...
          this._messageService.add({
            severity: 'error',
            summary: $localize`:@@waitlist.toast.error.summary:Something went wrong`,
            detail: $localize`:@@feedback.toast.error.detail:Could not send feedback. Please try again.`,
            life: 5000,
          });
        },
      });
